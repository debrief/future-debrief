...
export type ToolVaultCommand =
  ...
  | {
      ...
      payload: {
        ...
        values: (string | number | boolean | null | NestedArray)[];
      };
    }
  | {
      command: "showImage";
...
export type NestedArray = (string | number | boolean | null | NestedArray)[];

/**
 * Schema for defining a ToolVault tool, its inputs, and outputs.
 */
export interface ToolVaultToolDefinition {
  id: string;
  description: string;
  inputs?: (FeatureInput | NumberConfig | EnumConfig)[];
  output: ToolVaultCommand;
}
export interface FeatureInput {
  ...
  /**
   * Allowed feature.properties.dataType values
   */
  dataTypes?: string[];
  required?: boolean;
  minItems?: number;
