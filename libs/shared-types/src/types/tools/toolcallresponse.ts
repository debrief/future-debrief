...
/**
 * The ToolVault command result of the tool execution
 */
...
export interface ToolCallResponse {
  ...
  /**
   * Optional flag indicating if the result represents an error condition
   */
  isError?: boolean;
}
/**
