...
try:
    from ..types.annotation import AnnotationFeature
except ImportError:
    # If import fails, define a minimal type for validation
    class AnnotationFeature:  # type: ignore
        pass
...
def validate_multipoint_coordinates(coordinates: Any) -> bool:
    ...
    """
    return isinstance(coordinates, list) and all(validate_point_coordinates(coord) for coord in coordinates)
...
def validate_multilinestring_coordinates(coordinates: Any) -> bool:
    ...
    return isinstance(coordinates, list) and all(
        validate_linestring_coordinates(line_string) for line_string in coordinates
    )
...
def validate_multipolygon_coordinates(coordinates: Any) -> bool:
    ...
    """
    return isinstance(coordinates, list) and all(validate_polygon_coordinates(polygon) for polygon in coordinates)
