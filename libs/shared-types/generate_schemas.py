...
def main():
    ...
    models = {
        ...
        "derived/json-schema/tools/set_viewport_payload.schema.json": SetViewportPayload,
        "derived/json-schema/tools/set_selection_command.schema.json": SetSelectionCommand,
        "derived/json-schema/tools/set_selection_payload.schema.json": SetSelectionPayload,
        "derived/json-schema/tools/set_state_command.schema.json": SetStateCommand,
        "derived/json-schema/tools/set_state_payload.schema.json": SetStatePayload,
