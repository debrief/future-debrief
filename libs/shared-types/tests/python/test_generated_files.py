...
def test_file_content(filename, file_path):
    ...
    # Check for datamodel-codegen signature (newer versions use header comment)
    if "# generated by datamodel-codegen:" not in content:
        raise Exception(f"File {filename} doesn't appear to be generated by datamodel-codegen")
